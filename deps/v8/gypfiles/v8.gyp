...

{
  'variables': {
    ...
    'torque_outputs': [
      ...
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-proxy-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-proxy-from-dsl-gen.h',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-regexp-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-regexp-from-dsl-gen.h',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-regexp-replace-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-regexp-replace-from-dsl-gen.h',
      ...
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-string-html-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-string-html-from-dsl-gen.h',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-string-repeat-from-dsl-gen.cc',
      '<(SHARED_INTERMEDIATE_DIR)/torque-generated/builtins-string-repeat-from-dsl-gen.h',
